...
namespace Ticket_to_ride.Services
{
    public class PlayersBuilder
    {
        ...
        public List<Player> Build(RouteCardDeck routeCardDeck)
        {
            ...
            for (int i = 0; i < _numberOfAi; i++)
            {
                ...
                PlayerRouteHand routeCardsForPlayer = new AiRouteCardPicker().PickFourRouteCards(_map, routeCardDeck, 
                    currentPlayerId, new List<int> { Int32.MaxValue }, aiPlayerPersonality, _logger);
