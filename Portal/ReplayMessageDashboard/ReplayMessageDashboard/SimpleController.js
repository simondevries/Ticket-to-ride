...
var SimpleController = (function () {
    ...
    function SimpleController(playerTrainHandRepository, mapRepository, playerRouteHandRepository, game, $window) {
    ...
    SimpleController.prototype.load = function () {
        var _this = this;
        this.playerTrainHandRepository.getPlayerTrainHand(this.game.turnIndex)
            .then(function (resp) {
            _this.game.playerTrainHand = resp;
        });
        this.playerRouteHandRepository.getPlayerRouteHand(this.game.turnIndex).then(function (resp) {
            _this.game.playerRouteHand = resp;
        });
        this.mapRepository.getMap(this.game.turnIndex).then(function (resp) {
            _this.game.map = resp;
            _this.drawMap();
        });
    };
    SimpleController.prototype.drawMap = function () {
